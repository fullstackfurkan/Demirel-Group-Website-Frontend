            ...
            <div>
                <div className="md:flex p-15">
                    <div>
                        ...
                        <p>Türkiye’de inşaat sektörünün öncüsü olma vizyonuyla yola çıkan Demireller Group İnşaat, sahip olduğu güçlü insan kaynağı ve teknolojiye yaptığı yatırımlar sayesinde her gün insanların yaşamlarını iyileştirmeyi hedeflemektedir.</p>
                        <br />
                        <p>Teknoloji ile tasarımı uyum içinde harmanlayan Demirel Group İnşaat, sektörde standartları sürekli yükseltmeyi ve hayata geçirdiği her projede bir adım daha ileri gitmeyi ilke edinmiştir.</p>
                        <br />
                        ...
                        <br />
                        <p>Kaliteden ödün vermeden dünya standartlarında projeler üreten Demireller Group İnşaat, gelecekte de Türk inşaat sektörüne katkı sağlamaya ve değerlerini koruyarak ilerlemeye devam edecektir.</p>
                        <br />
                        ...
                        <br />
                        <div className="font-bold mt-4">Demireller Group İnşaat – Daha Mutlu Bir Gelecek İçin Tüm Zamanını ve Yeteneklerini Adıyor.</div>
                    </div>
